...
<body>
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content" style="width:100%;margin:-1px">
            ...
            <nav class="navbar navbar-expand navbar-dark sticky-top px-4 py-0 justify-content-between" style="height: 90px;width:100%;background-color:#171a1b !important">
                <h3 style="color:#93E567;">Laporan kas</h3>
                <a href="kas.php"> <button type="button" class="btn rounded-pill m-2" data-bs-toggle="modal" data-bs-target="#fol" name="editgrup" style="background-color:#93E567;color:#124d12"><i class="fa fa-mail-reply"></i>Kembali</button></a>


            </nav>
            <div class="cetak ms-5 mt-3 d-flex align-items-center ">
                <form  id="filterkas" method="post" style="height:50px;align-items:center;display:flex">
            ...
            <div class="container-fluid pt-4 px-4 w-100">
                <div class="text-center rounded p-4" style="background-color:#171a1b !important">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Data kas</h6>
                        <div class="cetak ms-5 mt-3">
                            <button class="me-2 btn btn-success me-2 ">
                                <a class="text-white" href="cetak_pdfkas_all.php">PDF</a>
                            </button>
                            <button class="me-2 btn btn-success me-2">
                                <a class="text-white" href="cetak_excelkas_all.php">EXCEL</a>
                            </button>
                            <button class="me-2 btn btn-success me-2">
                                <a class="text-white" href="cetak_printkas_all.php">PRINT</a>
    ...
    <script>
        function setFormAction(actionNumber) {
            var form = document.getElementById('filterkas');
            if (actionNumber === 1) {
                form.action = 'cetak_pdfkas_filter.php';
            } else if (actionNumber === 2) {
                form.action = 'cetak_excelkas_filter.php';
            } else if (actionNumber === 3) {
                form.action = 'cetak_printkas_filter.php';
            }
        }
    </script>

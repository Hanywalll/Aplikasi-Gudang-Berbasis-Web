    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content" style="width:100%;margin:-1px">
            ...
            <nav class="navbar navbar-expand  navbar-dark sticky-top px-4 py-0 justify-content-between" style="height: 90px;width:100%;background-color:#171a1b !important">
                <h3 style="color:#93E567;">Laporan Group</h3>
            ...
            <div class="container-fluid pt-4 px-4 w-100">
                ...
                <button class="me-2 btn btn-success">
                    <a class="text-white" href="cetak_pdfgroup_all.php">PDF</a>
                </button>
                <button class="me-2 btn btn-success">
                    <a class="text-white" href="cetak_excelgroup_all.php">EXCEL</a>
                </button>
                <button class="me-2 btn btn-success">
                    <a class="text-white" href="cetak_printgroup_all.php">PRINT</a>
                </button>
            </div>
                    ...
                    <div class="table-responsive">
                        <table border="1" class="table text-start align-middle table-bordered table-hover mb-0 border-light " id="colio" >
                            <thead>
                                ...
                                ?>
                                    <tr class="text-center text-white">
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-warning me-2" data-bs-toggle="modal" data-bs-target="#editgroup<?= $tampil['kodeg']; ?>">

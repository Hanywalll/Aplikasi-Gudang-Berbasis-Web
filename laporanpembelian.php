...
<body>
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content" style="width:100%;margin:-1px">
            ...
            <nav class="navbar navbar-expand navbar-dark sticky-top px-4 py-0 justify-content-between" style="height: 90px;width:100%;background-color:#171a1b !important">
                <h3 style="color:#93E567;">Laporan Pembelian</h3>
            ...
            <div class="cetak ms-5 mt-3 d-flex align-items-center ">
                <form  id="filterpembelian" method="post" style="height:50px;align-items:center;display:flex">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="cetak ms-5 mt-3">
                            <button class="me-2 btn btn-success me-2 ">
                                <a class="text-white" href="cetak_pdfpembelian_all.php">PDF</a>
                            </button>
                            <button class="me-2 btn btn-success me-2">
                                <a class="text-white" href="cetak_excelpembelian_all.php">EXCEL</a>
                            </button>
                            <button class="me-2 btn btn-success me-2">
                                <a class="text-white" href="cetak_printpembelian_all.php">PRINT</a>
    ...
    <script>
        function setFormAction(actionNumber) {
            var form = document.getElementById('filterpembelian');
            if (actionNumber === 1) {
                form.action = 'cetak_pdfpembelian_filter.php';
            } else if (actionNumber === 2) {
                form.action = 'cetak_excelpembelian_filter.php';
            } else if (actionNumber === 3) {
                form.action = 'cetak_printpembelian_filter.php';
            }
        }
    </script>

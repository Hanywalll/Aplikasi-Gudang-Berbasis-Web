...
<body>
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content" style="width:100%;margin:-1px">
            ...
            <nav class="navbar navbar-expand navbar-dark sticky-top px-4 py-0 justify-content-between" style="height: 90px;width:100%;background-color:#171a1b !important">
                <h3 style="color:#93E567;">Laporan Opname</h3>
            ...
            <div class="cetak ms-5 mt-3 d-flex align-items-center ">
                <form  id="filteropname" method="post" style="height:50px;align-items:center;display:flex">
                    <input class="rounded-pill" type="date" name="tanggal_awal" onkeypress="return preventEnter(event);" style="padding: 5px;width: 205px;" onchange="ubahBulanKeHuruf()" required>&nbsp;&nbsp;&nbsp;
                    <input class="rounded-pill" type="date" name="tanggal_akhir" onkeypress="return preventEnter(event);" style="padding: 5px;width: 205px;" onchange="ubahBulanKeHuruf()" required>&nbsp;&nbsp;
            ...
            <div class="container-fluid pt-4 px-4 w-100">
                <div class="text-center rounded p-4" style="background-color:#171a1b !important">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Data Opname</h6>
                        <div class="cetak ms-5 mt-3">
                            <button class="me-2 btn btn-success me-2 ">
                                <a class="text-white" href="cetak_pdfopname_all.php">PDF</a>
                            </button>
                            <button class="me-2 btn btn-success me-2">
                                <a class="text-white" href="cetak_excelopname_all.php">EXCEL</a>
                            </button>
                            <button class="me-2 btn btn-success me-2">
                                <a class="text-white" href="cetak_printopname_all.php">PRINT</a>
                    ...
                    <table class="table table-bordered text-center border-light text-white"  id="exportopname" width="100%" cellspacing="0">
                                                    <thead>
                                                        <tr>
  ...
  <script>
    function ubahBulanKeHuruf() {
      const inputTanggal = document.getElementById("tanggal1").value;
      
      const date = new Date(inputTanggal);
      const bulan = date.toLocaleString('default', { month: 'long' });

      const hasil = document.getElementById("hasil");
      hasil.textContent = "Anda memilih tanggal: " + bulan;
    ...
    <script>
        function setFormAction(actionNumber) {
            var form = document.getElementById('filteropname');
            if (actionNumber === 1) {
                form.action = 'cetak_pdfopname_filter.php';
            } else if (actionNumber === 2) {
                form.action = 'cetak_excelopname_filter.php';
            } else if (actionNumber === 3) {
                form.action = 'cetak_printopname_filter.php';
            }
        }
    </script>

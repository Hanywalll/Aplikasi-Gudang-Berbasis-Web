...
if (isset($_POST['addtransaksi'])) {
    ...
    $query = "SELECT MAX(urut) as max_id FROM pembelian WHERE tgltransaksi = '$tgltransaksi'";
    ...
    if ($max_id) {
     ...
     $addtotransaksi = mysqli_query($koneksi, "insert into pembelian (prefix,kodeb,urut,masuk,tgltransaksi,deskripsi) VALUES ('$bagian1$bagian2$bagian3','$kodeb','$new_id','$masuk','$tgltransaksi','$deskripsi')");
     //tambah stock
    // ambil data dari tabel stock
    $query    = mysqli_query($koneksi, "SELECT *FROM stock where kodeb = '$kodeb' AND  nota LIKE '%NPM%'");
    ...
    $cetakmasuk = mysqli_query($koneksi, "update tbbarang set masuq = '$total_masuk' where kodeb='$kodeb'");
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3" style="background-color:#171a1b !important;">
            <nav class="navbar " id="sidebar" >
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="pembelian.php" class="nav-item nav-link active"><i class="fa-solid fa-right-from-bracket fa-lg me-2"></i>Pembelian</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0 d-flex justify-content-between" style="height: 70px;background-color:#171a1b !important">
                ...
                <div id="info-slide" class="alert alert-success d-flex  mh-100 pt-4">
            ...
            <div class="container-fluid pt-4 px-4" style="display: flex;justify-content:space-between">
                <div>
                    <button type="button"  class="rounded-pill m-2" data-bs-toggle="modal" data-bs-target="#myModaltransaksi" style="padding: 7.5px 10px 7.5px 10px;color:#124d12;background-color:#93E567;font-weight:bolder"><i class="fa-solid fa-arrow-down"></i>&nbsp;Pembelian Barang</button>
                </div>
                <?php
                ...
                ?>
                <?php
                    $barangkeluar[] = $data['masuq'];
                    $jumlah[]       = $data['masuq'] * $data['hbeli'];
                }
                //total
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="text-center rounded p-4" style="background-color:#171a1b !important">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0" style="color:#93E567">Tabel Pembelian</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0 border-light" >
                            ...
                            <tbody>
                                <?php
                                $stokopname = mysqli_query($koneksi, "SELECT * FROM pembelian JOIN tbbarang ON pembelian.kodeb = tbbarang.kodeb ORDER BY nota");
                                $i = 1;
                                ...
                                ?>
                                    <tr class="text-white text-center">
                                        ...
                                        <td> <?=   number_format($tampil['masuk'], 2, ',', '.') ; ?></td>
...
<script>
 ...
 window.onscroll = function() {
     ...
     <script>
        ...
        var dataSlide = [
            { title: "Total Pengeluaran : " , content: "<?= " Rp.", number_format($total_harga, 2, ',', '.') ?>" },
            { title: "Total Pembelian : " ,content: "<?= number_format($total_barang, 2, ',', '.')?> Barang" },
        ];
            ...
            <form method="post" autocomplete="off">
                ...
                <label for="">
                    ...
                    <label for="">
                        ...
                        <input type="text" name="masuk" placeholder="Barang Masuk" style="height: 30px;width: 300px;text-align:center;font-weight:bold">
                    </label>
                    <br><br>
                    <label for="">
                            Deskripsi&ensp;&ensp;&nbsp;&nbsp;
